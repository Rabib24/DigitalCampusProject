    ...
    <div className="space-y-6 max-w-4xl">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Your performance across assignments and assessments
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid gap-2 text-sm">
            {gradeData.map((item) => (
              <div key={item.assignment} className="flex items-center justify-between">
                <span className="text-muted-foreground">{item.assignment}</span>
                <div className="flex items-center gap-2 w-40">
                  ...
                  <span className="w-10 text-right text-xs">{item.grade}%</span>
                </div>
              </div>
            ))}
          </div>
