...
def test_decorated_faculty_endpoints():
    """Test all faculty endpoints with decorated authentication"""
    print("Testing decorated faculty endpoints...")
    ...
    try:
        ...
        # Test dashboard overview (with permission check)
        print("\n1. Testing dashboard overview (with permission check)...")
        ...
        # Test courses list (basic faculty check)
        print("\n2. Testing courses list (basic faculty check)...")
        request = create_mock_request('GET', user, token)
        ...
        # Test assignments list (basic faculty check)
        print("\n3. Testing assignments list (basic faculty check)...")
        request = create_mock_request('GET', user, token)
        ...
        # Test research projects (basic faculty check)
        print("\n4. Testing research projects (basic faculty check)...")
        request = create_mock_request('GET', user, token)
        ...
        # Test analytics (basic faculty check)
        print("\n5. Testing analytics (basic faculty check)...")
        request = create_mock_request('GET', user, token)
        ...
        # Test recordings (basic faculty check)
        print("\n6. Testing recordings (basic faculty check)...")
        request = create_mock_request('GET', user, token)
        ...
        print("\n🎉 All decorated faculty endpoint tests completed!")
...
if __name__ == "__main__":
    test_decorated_faculty_endpoints()