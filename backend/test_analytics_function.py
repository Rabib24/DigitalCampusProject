...
from faculty.views import analytics
...
def test_analytics_function():
    """Test the faculty analytics function directly"""
    try:
        ...
        try:
            ...
            if response.status_code == 200:
                print("\n✓ Faculty analytics function test passed!")
                return True
            else:
                print(f"\n✗ Faculty analytics function test failed with status {response.status_code}")
                return False
        ...
        print(f"Error testing faculty analytics function: {e}")
        import traceback
        traceback.print_exc()
        return False

if __name__ == "__main__":
    print("Testing faculty analytics function directly...")
    success = test_analytics_function()
    if success:
        print("\n✓ Faculty analytics function test passed!")
    else:
        print("\n✗ Faculty analytics function test failed!")