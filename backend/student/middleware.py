...
class StudentRoleMiddleware(MiddlewareMixin):
    ...
    def process_request(self, request):
        print(f"Student Middleware processing request: {request.path}")
        # Only apply to student routes
        if request.path.startswith('/api/v1/student/'):
            print("Request is for student route")
            ...
            if request.path == '/api/v1/auth/login/':
                print("Skipping authentication for login")
                return None
            ...
            try:
                ...
                try:
                    ...
                    try:
                        ...
                        print(f"Student profile found: {student_profile.student_id}")
                        ...
                        print("Attached user and student to request")
